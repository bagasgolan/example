    ...
    <?php
       ...
       if(isset($_POST['submit'])) {
        ...
        if ($filename != "" ){
            ...
            echo "<script>alert('File Tidak Didukung'); window.location = 'edit_berita.php'</script>";
            ...
            if (!$size < 1050050) {
                ...
                echo "<script>alert('File Terlalu Besar'); window.location = 'edit_berita.php'</script>";
            }
        }
        } else {
