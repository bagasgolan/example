...
<body>
    <div class="container">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="user_berita">
            </div>
       ...
       if(isset($_POST['submit'])) {
        ...
        if(!in_array($extension, $file_extension)) {
            ...
            if (!$size < 1050050) {
                ...
                mysqli_query($koneksi, "INSERT into tb_berita values('$id_berita', '$judul_berita', '$user_berita', '$tanggal_berita', '$isi_berita', '$foto_berita')");
