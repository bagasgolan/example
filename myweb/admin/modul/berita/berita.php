...
<div class="container">
        ...
        <a class="navbar-brand" href="#">PESONA JOGJA</a>
        ...
        <br/>
        <a class="btn btn-primary" type="submit" href="tambah_berita.php" > [+] Tambah Berita</a>
        ...
        <table class="table mt-4">
            ...
            <tbody>
                ...
                <td>
                    ...
                    <a class="btn btn-danger" href="hapus_berita.php?id=<?php echo $r['id_berita']?>" role="button"  onclick="return confirm('Do You Want Delete?')">HAPUS</a> </td>
                </tr>
                <?php } ?>
            </tbody>
        </table>
