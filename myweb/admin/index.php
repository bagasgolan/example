...
<?php if (isset($_GET['error'])) { ?>
        ...
        <?php } ?>
            ...
            <div class="form-login">
                ...
                <input type="text" name="uname" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukan Username">
            </div>
            <br/>
            <div class="form-login">
            ...
            <br/>
            <a href="gagal_login.php"><label class="form-check-label" for="exampleCheck1">Forget Password ?</label></a>
            <br/>
            <br>
