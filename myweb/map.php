...
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/openlayers/2.12/lib/OpenLayers.js"></script>
...
window.onload = function() {
 ...
 var icon = new OpenLayers.StyleMap({
  'externalGraphic': 'img/icon/01.png',
  'graphicOpacity': 1.0,
  'graphicWith': 16,
  'graphicHeight': 32,
  'graphicYOffset': -32
 ...
 var map = new OpenLayers.Map({
  ...
  // set center
  'center': new OpenLayers.LonLat(110.39688,-7.80558),
...
<div id="map" style="position: fixed; width: 80%; height: 100%;"></div>
</body>
</html>
